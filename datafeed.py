...
#missing one of this module?, run pip install -r requirements.txt
import requests
import websockets
import pandas as pd
...
class common_:
    ...
    def get_auth_token():
        ...
        however,you may uncomment line 95 and comment line 94 not to signin'.
    ...
    def parse_ws_message(msg):
        ...
        if loc1[0] and loc1[1] is not None or loc1[0] ==loc1[1]:
            return msg.replace('unauthorized_user_token',common_.get_auth_token())
#             return msg
